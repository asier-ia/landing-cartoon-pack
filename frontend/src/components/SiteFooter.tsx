...
import { Camera, IceCreamCone, Mail, MessageCircle, Music, Star } from 'lucide-react'
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <PopIn delay={0.2}>
          <p className="mt-5 max-w-md text-pretty font-sans text-sm font-medium leading-relaxed text-cream/80">
            ...
            descubrir al helado campeón y nuestros próximos estrenos.
          </p>
        </PopIn>
        ...
        <p className="mt-10 font-heading text-xs text-cream/60">
          La Heladería Animada &copy; 1950 &middot; Hecho con cariño
        </p>
      </div>
    </footer>
  )
